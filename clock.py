...
hHand.color("white")
hHand.speed(10)
hHand.shapesize(stretch_wid=0.4, stretch_len=13)
...
mHand.color("white")
mHand.speed(10)
mHand.shapesize(stretch_wid=0.4, stretch_len=20)
...
sHand.speed(10)
sHand.shapesize(stretch_wid=0.4, stretch_len=30)
...
pen.hideturtle()
pen.goto(0, 300)
pen.write("12", align="center", font=("Algerian", 11, "bold"))
